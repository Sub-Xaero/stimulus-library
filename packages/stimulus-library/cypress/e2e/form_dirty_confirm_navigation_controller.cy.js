describe("Dirty form confirm navigation controller", () => {
  beforeEach(() => {
    cy.visit("controllers/dirty_form_confirm_navigation_controller.html");
  });
  it("Should set a data-dirty attribute when any of of a form's input are modified from the value it was created with", () => {
