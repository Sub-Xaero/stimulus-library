...
<StimulusPlayground
  controller="TweenNumberController"
  html={`<div style="text-align:center;">
  <div data-controller="tween-number"
    data-tween-number-start-value="0"
    data-tween-number-end-value="1000000"
    data-tween-number-duration-value="2000"
    data-tween-number-easing-value="easeOutExpo"
    data-tween-number-formatting-value='{"style":"decimal"}'
    style="font-size:3rem;font-weight:bold;font-family:monospace;color:#6366f1;">
    0
  </div>
  <p style="color:#6b7280;margin-top:0.5rem;">
    Animates on load (IntersectionObserver fires when visible)
  </p>
</div>`}
  editorHeight={200}
/>
