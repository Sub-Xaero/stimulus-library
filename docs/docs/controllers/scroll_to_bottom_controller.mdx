...
import ScrollToBottomControllerHtml from "../examples/scroll_to_bottom_controller.html.mdx";
import ScrollToBottomControllerHaml from "../examples/scroll_to_bottom_controller.haml.mdx";
...
<ScrollToBottomControllerHtml/>

## HAML


<ScrollToBottomControllerHaml/>
