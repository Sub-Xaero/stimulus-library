...
| --- | --- | --- |
| `active` | The class that is applied to the current active panel and link  | `is-active` |
| `hide` | The class used to hide all inactive content panels  | `hide` |
...
<iframe
  src="https://codesandbox.io/embed/tabscontroller-bgxk6?fontsize=14&hidenavigation=1&theme=dark"
