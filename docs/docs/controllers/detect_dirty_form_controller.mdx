...
import DetectDirtyFormControllerHtml from "../examples/detect_dirty_form_controller.html.mdx";
import DetectDirtyFormControllerHaml from "../examples/detect_dirty_form_controller.haml.mdx";
import DetectDirtyFormControllerCss from "../examples/detect_dirty_form_controller_css.css.mdx";
import DetectDirtyFormControllerJs from "../examples/detect_dirty_form_controller_js.js.mdx";
...
### Tracking dirty form inputs

## HTML

<DetectDirtyFormControllerHtml/>

## HAML

<DetectDirtyFormControllerHaml/>
...
<DetectDirtyFormControllerCss/>

#### JS


<DetectDirtyFormControllerJs/>
