...
<Sandpack
  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Signal Enable Example</h5>
          <div class="mb-3">
            <label class="form-label">Enter a number (3 or 5 to enable button)</label>
            <input
              type="number"
              class="form-control"
          ...
          <button
            ...
            data-controller="signal-enable"
            data-signal-enable-name-value="number"
      ...
      <div class="card mt-4">
        <div class="card-body">
          <h5 class="card-title">Multiple Conditions</h5>
          <div class="mb-3">
            <label class="form-label">Enter text (must be at least 5 characters)</label>
            <input
              type="text"
              class="form-control"
              data-controller="signal-input"
          ...
          <button
            class="btn btn-primary"
            data-controller="signal-enable"
            data-signal-enable-name-value="text"
            data-signal-enable-when-value=">=5"
          >
            Submit
          </button>
        </div>
    ...
    import { SignalInputController, SignalEnableController } from 'stimulus-library';
...
The controller enables/disables elements based on input values. In this example:

1. Two different use cases:
   - A button that's only enabled when the number input is 3 or 5
   - A button that's only enabled when the text input has at least 5 characters
2. Bootstrap styling for consistent appearance
3. Clear visual feedback when elements are enabled/disabled
