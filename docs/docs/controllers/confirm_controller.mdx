...
import ConfirmControllerHtml from "../examples/confirm_controller.html.mdx";
import ConfirmControllerHaml from "../examples/confirm_controller.haml.mdx";
...
<ConfirmControllerHtml/>

## HAML

<ConfirmControllerHaml/>
