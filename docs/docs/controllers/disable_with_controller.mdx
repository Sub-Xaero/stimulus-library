...
import DisableWithControllerHtml from "../examples/disable_with_controller.html.mdx";
import DisableWithControllerHaml from "../examples/disable_with_controller.haml.mdx";
...
<DisableWithControllerHtml/>

## HAML


<DisableWithControllerHaml/>
