...
import LightboxImageControllerHtml from "../examples/lightbox_image_controller.html.mdx";
import LightboxImageControllerHaml from "../examples/lightbox_image_controller.haml.mdx";
import LightboxImageControllerCss from "../examples/lightbox_image_controller.css.mdx";

## Purpose

To expand/show images in a lightbox view, for galleries or expanding thumbnails.

![lightbox_image_controller_example.gif](../assets/lightbox_image_controller_example.gif)
...
<LightboxImageControllerHtml/>

## HAML


<LightboxImageControllerHaml/>

## CSS


<LightboxImageControllerCss/>
