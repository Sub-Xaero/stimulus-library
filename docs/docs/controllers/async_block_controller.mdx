...
import AsyncBlockControllerHtml from "../examples/async_block_controller.html.mdx";
import AsyncBlockControllerHaml from "../examples/async_block_controller.haml.mdx";
...
<AsyncBlockControllerHtml/>

## HAML

<AsyncBlockControllerHaml/>
