...
import StickyControllerHtml from "../examples/sticky_controller.html.mdx";
import StickyControllerScss from "../examples/sticky_controller.scss.mdx";
...
![Sticky Action Bar](../assets/sticky_controller_example.gif)
...
<StickyControllerHtml/>

## SCSS

<StickyControllerScss/>
