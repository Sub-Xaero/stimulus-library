...
import CharCountControllerHtml from "../examples/char_count_controller.html.mdx";
import CharCountControllerHaml from "../examples/char_count_controller.haml.mdx";
...
<CharCountControllerHtml/>

## HAML

<CharCountControllerHaml/>
