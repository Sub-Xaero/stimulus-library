...
import TurboFrameRefreshControllerHtml from "../examples/turbo_frame_refresh_controller.html.mdx";
import TurboFrameRefreshControllerHaml from "../examples/turbo_frame_refresh_controller.haml.mdx";
...
<TurboFrameRefreshControllerHaml/>
