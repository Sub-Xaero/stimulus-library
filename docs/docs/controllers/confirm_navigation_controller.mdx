...
import ConfirmNavigationControllerHtml from "../examples/confirm_navigation_controller.html.mdx";
import ConfirmNavigationControllerHaml from "../examples/confirm_navigation_controller.haml.mdx";
import ConfirmNavigationControllerJs from "../examples/confirm_navigation_controller.js.mdx";
...
<ConfirmNavigationControllerHtml/>

## HAML

<ConfirmNavigationControllerHaml/>
