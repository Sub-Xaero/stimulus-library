...
| Class | Purpose |
| --- | --- |
| `countingDown` | The class to apply while the countdown is running |
| `ended` | The class to apply when the countdown has ended |
...
<iframe
  src="https://codesandbox.io/embed/countdowncontroller-y3nu7?fontsize=14&hidenavigation=1&theme=dark"
