...
import ClipboardControllerHtml from "../examples/clipboard_controller.html.mdx";
import ClipboardControllerHaml from "../examples/clipboard_controller.haml.mdx";
...
<ClipboardControllerHtml/>

## HAML

<ClipboardControllerHaml/>
