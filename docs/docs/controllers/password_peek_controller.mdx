...
import PasswordPeekControllerHtml from "../examples/password_peek_controller.html.mdx";
import PasswordPeekControllerHaml from "../examples/password_peek_controller.haml.mdx";
...
<PasswordPeekControllerHtml/>

## HAML

<PasswordPeekControllerHaml/>
