...
import WordCountControllerHtml from "../examples/word_count_controller.html.mdx";
import WordCountControllerHaml from "../examples/word_count_controller.haml.mdx";
...
<WordCountControllerHtml/>

## HAML

<WordCountControllerHaml/>
