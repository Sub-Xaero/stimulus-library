...
import FormSaveControllerHtml from "../examples/form_save_controller.html.mdx";
import FormSaveControllerHaml from "../examples/form_save_controller.haml.mdx";
...
<FormSaveControllerHtml/>

## HAML


<FormSaveControllerHaml/>
