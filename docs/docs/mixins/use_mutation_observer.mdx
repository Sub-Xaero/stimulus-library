...
The `useMutationObserver` hook allows you to observe changes to the DOM. It is a wrapper around the [MutationObserver API](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver).
