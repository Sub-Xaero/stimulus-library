...
| `insertPosition` | | `prepend` or `append` | Whether to place the given elements before or after the given element | |
...
export default class extends Controller {
  ...
  connect() {
    ...
    useInjectedElement(this, this.element, 'prepend', this.magicElement)
    // Inject some HTML into the DOM that the controller can use
    useInjectedHTML(this, this.element, 'prepend', `<p>Hello World</p>`);
